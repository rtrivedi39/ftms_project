...
$contents .= ' संबंध में जानकारी चाही है| ';
$contents .= '<tr><td colspan="2"><p class="text-justify shift-left" > प्रकरण पूर्व मे वर्ष  ';
if($is_genrate == true){
    $contents .= $post_data['year'];
}else{
	$contents .= '<input name="year" placeholder="year" type="text" />';
}
$contents .= ' को विधि विभाग मे आया था प्रकरण  मे  विभाग  द्वारा अपील स्वीकार कर अपील आदेश महाधिवक्ता जबलपुर  को दिनांक  को भेजे गये थे।  
</td></tr>'; 
$contents .= '<tr><td colspan="2"><p class="text-justify shift-left" >अतः संबंधित जानकारी से शासकीय अधिवक्ता को अवगत कराया जाना उचित होगा। विभाग की पूर्व नस्ती  पताका "ए" पर रखी है ।</p><br/></td></tr>';
$contents .= '<tr><td colspan="2"><p class="text-justify shift-left" > नस्ती आदेशार्थ प्रस्तुत है । </p><br/></td></tr>';
