...
$contents  .= '</td></tr>';
$contents  .= '<tr><td><p>फा.क्रमांक 17(ई)17-2016/21-ब(एक) '.$file_number.'/'.date("Y").'  , कामर्शियल कोर्ट, कामर्शियल डिवीजन एंड कामर्शियल अपीलेट डिवीजन आॅफ हाईकोर्ट एक्ट, 2015 (2016 का 4) की धारा 3 की उपधारा (1) एवं उपधारा (2) द्वारा प्रदत्त शक्तियों को प्रयोग में लाते हुए, राज्य षासन, मध्यप्रदेष उच्च न्यायालय के परामर्ष से, एतद्द्वारा, नीचे दी गई सारणी के कालम (2) में उल्लिखित जिलों के लिये जिला स्तर पर, कालम (3) में यथा विनिर्दिष्ट क्षेत्र की स्थानीय सीमाओं के लिए उक्त अधिनियम के अधीन उन्हें प्रदत्त क्षेत्राधिकार एवं षक्तियों का प्रयोग करने के प्रयोजन से, वाणिज्यिक न्यायालयों का गठन करता है, अर्थात्ः- </p></td></tr>';
...
$contents  .= '<tr><td><p>F.No-17(E)17-2016-/21-B(1)– '.$file_number.'/'.date("Y").'  In exercise of the powers conferred by sub-section (1) and (2) of section 3 of the Commercial Courts, Commercial Division and  Commercial Appellate Division of High Courts Act, 2015 (No. 4 of 2016)  the State Government, with the consultation of the High Court, hereby constitutes Commercial Courts at District level for the districts mentioned in column (2) of table given below for the purpose of exercising the jurisdiction and powers conferred on them under the said Act for the local limits of the area, as specified in column (3) thereof, namely:-</p></td></tr>';
$contents .= '<tr><td align="center">
		<table width="100%" id="tbl_three_column1" class="three_column1" border="1px">
		<thead><tr>
		<th>S. No. </th>
		<th>District </th>
		<th>Local limits of area  </th>
		</tr></thead>		
		<tbody><tr>
		<td align="center"><b>(1)</b></td>
		<td align="center"><b>(2)</b></td>
