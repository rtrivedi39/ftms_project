...
$contents .= '</u></b></td></tr>';
$contents .= '<tr><td><p>फा0क्रमांक 1(सी)/'.$file_number.'/'.date('Y').'/एट्रोसिटी/21-ब(दो), राज्य शासन, अनुसूचित जाति और अनुसूचित जनजाति (अत्याचार निवारण) अधिनियम, 1989 की धारा-14 के अनुसार ';
if($is_genrate == true){
...
if($is_genrate == true){ 
    $contents .=  get_date_formate($post_data['ad_name'],'d/m/Y');
} else {
...
$contents .= ' में विशिष्ठ ज्येष्ठ अधिवक्ता नियुक्त करता है। </p></td></tr>';
...
$contents .= ' द्वारा कार्यभार ग्रहण करने के दिनांक से तीन वर्ष के लिये होगी। यह नियुक्ति बिना कोई कारण बताये समाप्त की जा सकती है। किसी भी स्थिति में 62 वर्ष की आयु के पश्चात् वे उक्त पद पर कार्य करने हेतु अर्ह नहीं होंगे। विशेष लोक अभियोजक की अनुपस्थिति के दिनांक पर विशेष न्यायालय में केवल उस दिन की कार्यवाही हेतु पैनल अधिवक्ता को कार्य चक्रानुक्रम से जिला दण्डाधिकारी द्वारा आवंटित किया जायेगा।</p></td></tr> ';
$contents .= '<tr><td><p>नियुक्त अभिभाषक को शुल्क आदि विधि और विधायी कार्य विभाग के आदेश क्रमांक 1(सी)एट्रोसिटी/21-ब(दो), दिनांक ';
if($is_genrate == true){ 
...
$contents .= '<tr><td><div style="float:left">पृ0 क्रमांक1(सी)/'.$file_number.'/'.date('Y').'/एट्रोसिटी/21-ब(दो), </div><div style="float:right">भोपाल, दिनांक  ';
if($is_genrate == true){
