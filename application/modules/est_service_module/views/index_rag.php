                                                    ...
                                                    if($fetch_category['master_category_id'] == $get_cat['parent_category_id']){  ?>
                                                        <div class="col-md-6">
                                                            <div class="box box-success">
                                                                ...
                                                                <div class="box-body">
                                                                    <?php $gpf_dpf_check = array('53' , '52');
                                                                    $local_bill = array('31');  ?>

                                                                    <?php if(in_array($get_cat['parent_category_id'],$local_bill)) { ?>
                                                                        <?php  if($get_cat['master_category_id'] == '157') { ?>
                                                                            <a href="<?php echo base_url(); ?>establishment/oth_bill_forms/<?php echo $get_cat['parent_category_id']; ?>/<?php echo $get_cat['master_category_id']; ?>?file_id=<?php echo $bill_file_id ; ?>"><button type="button" class="btn btn-primary"><i class="fa fa-edit"></i> आवेदन करें</button></a>
                                                                        <?php } ?>
                                                                        <a href="<?php echo base_url(); ?>establishment/bill_list/<?php echo $get_cat['master_category_id']; ?>"><button type="button" class="btn btn-primary"><i class="fa fa-fw fa-list"></i> बिल आवेदन</button></a>
                                                                    <?php }elseif(in_array($get_cat['parent_category_id'],$gpf_dpf_check)){ ?>
                                                    ...
                                                    if($fetch_category['master_category_id'] == $get_cat['parent_category_id']){  ?>
                                                        <div class="col-md-6">
                                                            <div class="box box-default">
                                                                ...
                                                                <div class="box-body">
                                                                    <?php
                                                                    $gpf_dpf_check = array('53' , '52');
                                                                    $local_bill = array('31');
                                                                    ?>
                                                                    <?php if(in_array($get_cat['parent_category_id'],$gpf_dpf_check)) { ?>
                                                                    ...
                                                                    <?php } elseif(in_array($get_cat['parent_category_id'],$local_bill)) { ?>
                                                                        <a href="<?php echo base_url(); ?>establishment/user_bill_forms/<?php echo $get_cat['parent_category_id']; ?>/<?php echo $get_cat['master_category_id']; ?>"><button type="button" class="btn btn-primary"><i class="fa fa-edit"></i> आवेदन करें</button></a>
                                                                        <a href="<?php echo base_url(); ?>establishment/user_bill_list/<?php echo $get_cat['master_category_id']; ?>/<?php echo $this->session->userdata('emp_id'); ?>"><button type="button" class="btn btn-primary"><i class="fa fa-fw fa-list"></i> बिल आवेदन</button></a>
                                                                    <?php } ?>
                                                                    <button type="button" onclick="open_rules_pdf(<?php echo $get_cat['master_category_id']; ?>)" value="<?php echo $get_cat['master_category_id']; ?>" class="btn btn-primary get_rules_pdf"><i class="fa fa-fw fa-paperclip"></i> नियम</button>
