...
$back1_financial_year = get_financial_year(1);
$back2_financial_year = get_financial_year(2);
$back1_financial_year_array = explode('-',$back1_financial_year);
$back2_financial_year_array = explode('-',$back2_financial_year);
?>
...
if(!empty($check1) && ($uri2 != 'edit_service_forms' && $uri2 != 'service_forms')){ ?> 
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box">
                <form role="form" method="post" action="<?php echo base_url()?>est_service_module/gpfdpf_manage/manage_gpf_dpf"  enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group text-center"><h3>भविष्य निधि खाते से <?php if($uri4 == '97' || $uri4 == '98'){ echo "अस्थाई"; }elseif($uri4 == '131' || $uri4 == '130'){echo "आंशिक अंतिम"; }  ?> के  आहरण हेतु आवेदन <br>(अभिदाता द्वारा भरा जाने वाला आवेदन )</h3></div>
                        ...
                        <div class="form-group col-md-6">
                            <input type="text" required class="form-control" name="dpf_account_no" id="dpf_account_no" placeholder="खाता क्रमांक"  />
                        </div>
                        ...
                        <div class="form-group  col-md-4"><?php echo "&nbsp;&nbsp;&nbsp;(क) विगत दो वर्ष पूर्व का वर्ष "; /* $before_year = date('Y')-2; $current_ye = date('Y')-1 ; echo $before_year .'-'.$current_ye*/ echo $back2_financial_year ; ?></div>

                        <div class="form-group col-md-6">
                            <input type="hidden" name="previous_year_txt" id="previous_year_txt" value="<?php echo $back2_financial_year_array[0]; ?><?php // echo date('Y') - 1; ?>">
                            <input type="text" required class="form-control" name="previous_year_amnt" id="previous_year_amnt" autocomplete="off">
                        </div>

                        <div class="form-group  col-md-4"><?php echo "&nbsp;&nbsp;&nbsp;(ख) विगत वर्ष "; /* $current_ye = date('Y')-1 ;$after_year = date('Y'); echo $current_ye .'-'.$after_year ; */ echo $back1_financial_year; ?> में जमा</div>

                        <div class="form-group col-md-6">
                            <input type="hidden" name="current_year_txt" id="current_year_txt" value="<?php echo $back1_financial_year_array[0]; ?><?php // echo date('Y'); ?>">
                            <input type="text" required class="form-control" name="current_year_amnt" id="current_year_amnt" autocomplete="off"/>
                        </div>
						
						<div id="curr_current_year_div" style="display: none">
                        <div class="form-group  col-md-4"><?php echo "&nbsp;&nbsp;&nbsp;(ग) वर्ष "; /* $current_ye = date('Y') ;$after_year = date('Y')+1; echo $current_ye .'-'.$after_year ;*/ echo $curr_financial_year ;?> में जमा</div>

                        <div class="form-group col-md-6">
                            <input type="text" class="form-control" name="curr_current_year_amt" id="curr_current_year_amt" autocomplete="off"/>
                        </div>
                        </div>
                        ...
                        <div class="form-group col-md-4"><?php echo "5. (क) ."; ?> <?php if($uri4 == '97' || $uri4 == '98'){ echo "अस्थाई अग्रिम"; }elseif($uri4 == '131' || $uri4 == '130'){echo "आंशिक अंतिम"; }  ?> <?php echo $this->lang->line('manage_gpfdpf_temp_less_last_gpf'); ?></div>

                        <div class="form-group col-md-2">
                            <input class="form-control" name="applied_amount_adv" id="applied_amount_adv" placeholder="<?php echo $this->lang->line('manage_gpfdpf_temp_less_last_gpf'); ?>" onkeyup="test_skill()"/>
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-12 text-danger check_show" style="display: none"><div class="col-md-4"></div>अधिकतम अपेक्षित राशि : <b> <span id="max_amount"></span> /-</b></div>
                        ...
                        <input type="hidden" name="pay_curr_financial_yr" id="pay_curr_financial_yr" value="<?php echo $curr_financial_year ; ?>" />
