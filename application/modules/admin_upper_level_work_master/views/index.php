                  ...
                  <table id="leave_employee" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th><?php echo $this->lang->line('list_label_action'); ?></th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php $i=1; foreach ($get_otherwork as $key => $otherworklist) { ?>
                        <tr>
                          ...
                          <td>
                              <div class="btn-group">
                                <a href="<?php echo base_url('admin');?>/edit_otherwork/<?php echo $otherworklist['other_work_id'];?>" class="btn  btn-twitter"><?php echo $this->lang->line('list_button_action'); ?></a>
