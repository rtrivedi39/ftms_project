...
<div class="col-md-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
		 ...
		 <form role="form" method="post" action="<?php echo base_url()?>dashboard/save_dealing_procedution<?php if(isset($file_data[0]['file_id'])){ echo '/'.$file_data[0]['file_id'];} ?>"  enctype="multipart/form-data">
		   ...
		   <div class="box-body">
                ...
                <div class="col-md-6">
					<?php if(in_array($file_data[0]['file_mark_section_id'],array('2','10','14'))){ ?>
						<div class="form-group">
							<label for="judgement_data"><?php echo $this->lang->line('judgement_data'); ?> <span class="text-danger">*</span></label>
							<input type="text" name="judgement_data" id="judgement_data" value="<?php echo isset($file_data[0]['file_judgment_date']) ? date_format(date_create($file_data[0]['file_judgment_date']),'d-m-Y') : ''; ?>" class="form-control">
					...
					<?php } else if($file_data[0]['file_mark_section_id']==15){ ?>
						<div class="form-group">
									...
									<select class="form-control" id="section_file_type" name="section_file_type" required>
					...
					<div class="form-group" id="pre_application" style="display:none">
                        <label for=" private_application"><?php echo $this->lang->line('label_abhayabedak_name'); ?></label>
                        <input type="text" class="form-control" name="private_application" id="private_application" >
                   </div>
                    ...
                    <div class="form-group">
                     ...
                     //   if($file_data[0]['case_no']!=''){  }
                        ...
                        foreach ($c1 as $case_no_type) {
							...
							<?php if($file_data[0]['file_mark_section_id']!=15){?>
                                <div class="col-xs-4">
                                    <select name="files_other_feilds[case_type][<?php echo $i ?>]" class="form-control" required="">
                                        <option value="">Select</option>
							...
							<?php } ?>
                                ...
                                <div class="col-xs-4">
                                    <select Name='files_other_feilds[case_year][<?php echo $i ?>]' class="form-control" required=""><?php
                    ...
                    <div class="box-footer text-right">
                        <button class="btn btn-primary" onclick="return confirm('कृपया सुनिश्चित करे की आप यह फाइल दर्ज करना चाहते हैं |')" type="submit"><?php echo $this->lang->line('button_submit'); ?></button>
                        <button name="link_file" value="link_file" class="btn btn-primary" onclick="return confirm('कृपया सुनिश्चित करे की आप यह फाइल दर्ज करना चाहते हैं |')" type="submit">Update + Link file to other file</button>
                    </div>
