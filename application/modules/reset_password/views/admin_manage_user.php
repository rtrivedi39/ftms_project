                        ...
                        <div class="box box-primary" style="margin-top: 15px;">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="emp_detail_dob" name="emp_detail_dob" value="<?php echo (@$emp_more_detail['emp_detail_dob'] ? @$emp_more_detail['emp_detail_dob'] : $this->input->post('emp_detail_dob')); ?>"  class="form-control">
                        ...
                        <div class="box box-primary" style="margin-top: 15px;">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $state_list = get_list(STATES, 'state_name', array('country_id' => '1')); //pre($yesno_array);  ?>
                                    <select class="form-control" name="emp_detail_state">
                                        <option value="">Select</option>
                                        <?php foreach ($state_list as $stateky => $stateval) { ?>
                                        <option value="<?php echo $stateval['state_id']; ?>" <?php if (@$emp_more_detail['emp_detail_state'] == $stateval['state_id']) {echo 'selected';} else if ($this->input->post('emp_detail_state') == $stateval['state_id']) {echo 'selected';} ?>><?php echo $stateval['state_name']; ?></option>
                                        <?php } ?>
                                    </select>
