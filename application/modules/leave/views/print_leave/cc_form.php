    ...
    <div class="col-md-12">
		...
		<div class="row">          
			<div class="col-md-12 text-left">
				<table class="table borderless">
					...
					<tr><td>11. </td><td>Reason(s) for leave applied for</td><td>.......................</td></tr>
		...
		<hr/>       
			<div class="col-md-3 text-center">
				<button type="button" onclick="printContents('cc_form')" class="btn btn-primary" name="">प्रिंट करे</button>
			</div>
			<div class="col-md-3 text-center">
