    ...
    <div class="row">
        <div class="col-xs-6">
            <div class="box box-primary">
                ...
                <form enctype="multipart/form-data" id="leaveForm" role="form" method="post" action="<?php echo base_url() ?>leave/addleave">
                    <div class="box-body">
                                            ...
                                            <div class="col-md-6 ">
                                                <b> <?php
                                                    echo isset($user_det->emp_full_name_hi) ?
                                                            get_employee_gender($user_det->emp_id).' '.$user_det->emp_full_name_hi . ' / ' . getemployeeRole($user_det->role_id) :
                                                            '';
                                                    ?></b>
                                            </div>
                                        </div>
                        ...
                        <div class="hide_class headquoters_leave ">
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleInputFile"><?php echo $this->lang->line('hq_time'); ?> <span class="text-danger">*</span></label>
                                <input type="text"  name="hq_time" id="hq_time"  class="form-control" placeholder="आज सुबह से कल शाम तक">
                            </div> 
                        </div>	
                        ...
                        ?>>
                            <div class="form-group col-md-6">
                                ...
                                <input type="text"  name="pay_grade_pay" id="pay_grade_pay"  class="form-control" value="1200 + 9300">
                         ...
                         <div class="clearfix"></div>
                        <div class="form-group col-md-12 certificate <?php
                        ...
                        ?>">
                            <label for="exampleInputFile"><?php echo $this->lang->line('leave_upload_medical_file'); ?></label>
                    ...
                    <div class="box-footer">
                        <button class="btn btn-primary" type="submit" onclick="" id="leaveFormSubmit"><?php echo $this->lang->line('submit_botton'); ?></button>
                    ...
                    <table class='table table-bordered' style="table-layout: fixed;"> <tr class="text-center">
                        ...
                        <tr class="text-center">
                            ...
                            <?php for ($i = 1; $i <= $daysInMonth; $i++): ?>
                                ...
                                <?php elseif(in_array($on_date, holidays_2015())): ?>
