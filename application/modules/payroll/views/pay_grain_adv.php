...
<th width='15%'><?php echo  "शेष"; ?></th>
                          ...
                          <tr id="<?php echo $pay->pay_id; ?>">
                                 ...
                                 <td  width='10%'><?php echo get_employee_gender(emp_nmae($pay->pay_emp_unique_id)[0]->emp_id) ." ". emp_nmae($pay->pay_emp_unique_id)[0]->emp_full_name_hi . "(".  get_employee_designation_id(emp_nmae($pay->pay_emp_unique_id)[0]->emp_id).")"; ?></td>
                                      <td width='25%'> <?php echo  @getiadvamount($pay->pay_emp_unique_id,1)[0]->pea_amount; ?></td>    
                                      <td width='25%'> <?php echo @getinstlment($pay->pay_emp_unique_id,$pay->pay_month,$pay->pay_year,1)[0]->emi_no_installment; ?></td>    
   ...
   <td width='25%'> <?php echo  @getiadvamount($pay->pay_emp_unique_id,1)[0]->pea_amount- $ddtotal ?></td>    
  ...
  <?php }}  ?><tfoot>
      <tr style="background-color: #8BC34A; font-size: 16px;font-weight: bold;    color: #000;">
                                    ...
                                    <th width="10%"></th> 
                                     <th width="10%"></th>
                                     <th width="10%">Total </th> <th width="10%"></th>
  <th width="10%"></th> 
