...
<div class="row">
	...
	<?php 
	$emp_pay_cate = fetch_paycate($_GET['uid']);

	if($emp_pay_cate['emp_pay_cate_id'] == 4){
	if($_GET['uid'] != "51011068" && $_GET['uid'] != "51011071"){
				?>
				<div class="col-md-3">
 ...
 <br/>2015-2016</a>
	...
	<?php } }else{
		 echo "<h2 style='color: #d04c23;'> ".$emp_pay_cate['emp_title_hi']." ".$emp_pay_cate['emp_full_name_hi']. " की  डी पी एफ स्लिप  उपलब्ध नहीं है | </h2>";
