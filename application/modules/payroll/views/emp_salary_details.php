...
<div class="row">
   ...
   <form action="<?php echo base_url(); ?>payroll/showdetails" method="get" >
        <div class="box-body">
              ...
              <div class="form-group">
                <label for="exampleInputEmail1"><?php echo "आदेश का विषय "?><span class="text-danger">*</span></label>
                <textarea name="subjet" class="form-control" id="subjet" placeholder=""></textarea>
                
              </div>
                    <div class="form-group">
                <label for="exampleInputEmail1"><?php echo "वेतन का कारण"?><span class="text-danger">*</span></label>
                 <select name="type" name="type" class="form-control">
                                <option value=""><?php echo "वेतन देयक का कारण" ?></option>
                                <option value="1" > पुराना अवकास मंजूरी </option>
								
                                    <option value="2" >स्थानांतरण </option>
                            </select> 
                
              </div>
               <div class="col-xs-6" id="dis1" >
                                  <div class="form-group">
                <label for="exampleInputEmail1"><?php echo "वेतन महीने" ?><span class="text-danger">*</span></label>
               <?php $currentmonth = date('F'); ?>
                  <select name="pay_month" name="pay_month" class="form-control">
                                <option value=""><?php echo "वेतन महीने " ?></option>
                                <?php for ($m=1; $m<=12; $m++) {
