...
<thead>   <tr>
                    <th width='15%'> </th>
                                    ...
                                    <th width='25%'><?php echo  "शासकीय आवास क्रमांक" ?></th>
                                     
                                   <?php } ?>
                              <?php if($dd_key == "pay_gpf" || $dd_key == "pay_dpf"){ ?>
                                <th width="20%"><?php echo "जी पी फ & डी पी फ खता नंबर "; ?></th>
                                <th width="20%"><?php echo $this->lang->line('basic_pay'); ?></th>


                            <?php }elseif($dd_key == "pay_income_tax"){?>
                                <td ><?php echo "पेन नंबर"; ?></td>
                                  <td ><?php echo $this->lang->line('pay_amount'); ?></td>
                                  <?php } ?>
                          <th width='25%'><?php echo  $this->lang->line($dd_key ); ?></th>
                          <?php if($dd_key == "pay_gpf"){ ?>
                                    <th width='25%'><?php echo  $this->lang->line('pay_gpf_adv'); ?></th>
                          ...
                          <tr id="<?php echo $pay->pay_id; ?>">
                                 ...
                                 <td ><?php echo get_employee_gender(emp_nmae($pay->pay_emp_unique_id)[0]->emp_id) ." ". emp_nmae($pay->pay_emp_unique_id)[0]->emp_full_name_hi. "(".  get_employee_designation_id(emp_nmae($pay->pay_emp_unique_id)[0]->emp_id).")"; ?></td>
                                  ...
                                  <td ><?php $pen= getemppenno($pay->pay_emp_unique_id);echo $pen['emp_house_no']."[".$pen['emp_house_type']."]"?></td>
