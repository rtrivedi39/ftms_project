		...
		tr.printdrak{
		  background-color:#FF9800 !important;
                  ...
                  color: #000 !important; " class="printdrak">
                               ...
                               <th style="padding:0;">  <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
                        <input type="numbar" id="darate<?php echo $pay->pay_id; ?>" name="pay_basic" value="" ></div></th> <th ><?php echo date("M",strtotime($pay->pay_month)); ?></th>
                                        <?php if($dataval[0]['pay_cate_basic'] == 1){ 
...
print-color-adjust: exact;
               ...
               <input type="hidden" name="no_updated" id="no_updated<?php echo $pay->pay_id;?>" value="<?php echo $pay->no_updated +1; ?>" >
                              ...
                              <div class="username<?php echo $pay->pay_id; ?>" id="pay_basic112"><?php echo $pay->pay_basic;  $pay_basictotal = $pay->pay_basic +   $pay_basictotal; ?></div>

                      <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
                        <input type="numbar" id="pay_basic<?php echo $pay->pay_id; ?>" onfocus="checkeda(<?php echo $pay->pay_id; ?>)" name="pay_basic" value="<?php echo $pay->pay_basic;  ?>" ></div>                            </th>
                                 <?php }if($dataval[0]['pay_cate_grp'] == 1){  ?>
                                             <?php 
...
print-color-adjust: exact;
                                 ...
                                 <th  class="changehead">
                              <?php } ?> <div class="username<?php echo $pay->pay_id; ?>" id="pay_grp"> <?php echo $pay->pay_grp;  $pay_grptotal = $pay->pay_grp +   $pay_grptotal ; ?></div>
  <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
    <input type="numbar" id="pay_grp<?php echo $pay->pay_id; ?>" name="pay_grp" onfocus="checkeda(<?php echo $pay->pay_id; ?>)"  value="<?php echo $pay->pay_grp;  ?>" ></div>                                    </th>
                              <?php }if($dataval[0]['pay_cate_special'] == 1){  ?>
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                      ...
                                      <?php echo $pay->pay_special;  $pay_specialtotal = $pay->pay_special + $pay_specialtotal ; ?></div>
                                        <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
                                          <input type="numbar" name="pay_special"  onfocus="checkeda(<?php echo $pay->pay_id; ?>)" id="pay_special<?php echo $pay->pay_id; ?>"value="<?php echo $pay->pay_special;  ?>" ></div>                                    </th>
                                    <?php }if($dataval[0]['pay_cate_da'] == 1){  ?>
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
<div class="username<?php echo $pay->pay_id; ?>" id="pay_grp">   <?php  echo  $pay->pay_da; $pay_datotal = $pay->pay_da + $pay_datotal ; ?></div>
  <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
    <input type="numbar" id="pay_da<?php echo $pay->pay_id; ?>" name="pay_da" onfocus="checkeda(<?php echo $pay->pay_id; ?>)"   value="<?php echo $pay->pay_da;  ?>" ></div>
                                 </th>
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
							<div class="username<?php echo $pay->pay_id; ?>" id="pay_special">
                                      <?php echo $pay->pay_others; $pay_otherstotal = $pay->pay_others + $pay_otherstotal ; ?></div>
                                  <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                      ...
                                      <div class="username<?php echo $pay->pay_id; ?>" id="pay_special">
                                        <?php echo $pay->pay_sa; $pay_satotal = $pay->pay_sa + $pay_satotal ; ?></div>
                        <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                      ...
                                      <div class="username<?php echo $pay->pay_id; ?>"  id="pay_special">
                                      <?php echo $pay->pay_madical;$pay_maotal = $pay->pay_madical + $pay_maotal; ?></div>
                        <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                    <div class="username<?php echo $pay->pay_id; ?>" id="pay_special">
                                      <?php echo $pay->pay_sp; $pay_sptotal = $pay->pay_sp + $pay_sptotal; ?>                                              </div>
                                      <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                    ...
                                    <div class="username<?php echo $pay->pay_id; ?>" id="pay_special">
                                      <?php echo $pay->pay_ca;$pay_catotal = $pay->pay_ca + $pay_catotal;  ?>                                          </div>
                                      <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                    <div class="username<?php echo $pay->pay_id; ?>" id="pay_special">
                                      <?php echo $pay->pay_hra;$totalpay_hratotal = $pay->pay_hra + $totalpay_hratotal;  ?>                                          </div>
                                      <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                           ...
                           <?php echo $pay->pay_total_sum; $pay_total_sumtotal = $pay->pay_total_sum + $pay_total_sumtotal; ?></th>
                             <?php if($dataval[0]['pay_cate_gpf'] == 1){  ?>
...
print-color-adjust: exact;
                          ...
                          <div class="username<?php echo $pay->pay_id; ?>">
                                      <?php echo $pay->pay_gpf; $pay_gpftotal = $pay->pay_gpf + $pay_gpftotal;  ?>                                     </div>
                                      <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                <div class="username<?php echo $pay->pay_id; ?>" id="pay_special" > 
                                    ...
                                    <?php echo  $pay->pay_gpf_adv; $pay_gpf_advtotal = $pay->pay_gpf_adv + $pay_gpf_advtotal;  ?> </div>
                                   <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> <div class="username<?php echo $pay->pay_id; ?>" id="pay_special"> 
                                   ...
                                   <?php echo   $pay->pay_dpf; $pay_dpftotal = $pay->pay_dpf + $pay_dpftotal;  ?>
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                      ...
                                      <?php echo   $pay->pay_dpf_adv;  $pay_dpf_advtotal = $pay->pay_dpf_adv + $pay_dpf_advtotal;?>                                    </div>
                                   <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                  ...
                                  <div class="username<?php echo $pay->pay_id; ?>" id="pay_special"> 
                                      ...
                                      <?php echo $pay->pay_defined_contribution;$pay_defined_contributiontotal = $pay->pay_defined_contribution + $pay_defined_contributiontotal;?>                                            </div>
                                   <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                      ...
                                      <?php echo $pay->pay_gias;$pay_giastotal = $pay->pay_gias + $pay_giastotal; ?>                                           </div>
                                   <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                          ...
                          <div class="username<?php echo $pay->pay_id; ?>" id="pay_special"> 
                              ...
                              <?php echo $pay->pay_house_loan;$pay_house_loantotal = $pay->pay_house_loan + $pay_house_loantotal;  ?>                                </div>
                                   <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                    <div class="username<?php echo $pay->pay_id; ?>" id="pay_special"> 
                                      ...
                                      <?php echo $pay->pay_car_loan; $pay_car_loantotal = $pay->pay_car_loan + $pay_car_loantotal; ?>                                    </div>
                                   <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                  ...
                                  <?php echo $pay->pay_house_rent; $pay_house_renttotal = $pay->pay_house_rent + $pay_house_renttotal; ?></div>
                                    <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                    ...
                                    <?php echo $pay->pay_fuel_charge;$pay_fuel_chargetotal = $pay->pay_fuel_charge + $pay_fuel_chargetotal;?>                                    </div>
                                    <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
                                    <input type="numbar" id="pay_fuel_charge<?php echo $pay->pay_id; ?>" value="<?php echo $pay->pay_fuel_charge;  ?>" name="pay_fuel_charge"  >
                                  </div>                                  </th>  <?php }if($dataval[0]['pay_cate_garain_adv'] == 1){  ?>
...
print-color-adjust: exact;
                                      ...
                                      <?php echo $pay->pay_grain_adv;$pay_grain_advtotal = $pay->pay_grain_adv + $pay_grain_advtotal ?>                                      </div>
                                    <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php echo $pay->pay_festival_adv; ?>                                </div>
                                    <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                      ...
                                      <?php echo $pay->pay_professional_tax; ?>                                      </div>
                                    <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                  ...
                                  <?php echo $pay->pay_income_tax ?> </div>
                                    <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                    <div class="username<?php echo $pay->pay_id; ?>" id="pay_special"> 
                                      ...
                                      <?php echo $pay->pay_other_adv ?>                                      </div>
                                    <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
                                  ...
                                  <!--  <th width="10%"></th>-->
								   <th width='25%'></th>
                                     ...
                                     <th width="10%">Total </th>
                                        <?php if($dataval[0]['pay_cate_basic'] == 1){  ?>
                            <th width='25%'><?php echo $pay_basictotal ;  ?></th>
                                 <th width='25%'>&nbsp;</th>
                                 <?php }if($dataval[0]['pay_cate_grp'] == 1){  ?>
                                    <th width="10%"><?php echo  $pay_grptotal ; ?></th>
                              <?php }if($dataval[0]['pay_cate_special'] == 1){  ?>
                                    <th width='25%'><?php echo  $pay_specialtotal   ?></th>
                                    <?php }if($dataval[0]['pay_cate_da'] == 1){  ?>
                                   <th width="15%"><?php  echo  $pay_datotal ?></th>
                                   <?php }if($dataval[0]['pay_cate_other_add'] == 1){  ?>
                                    <th width='5%'><?php echo  $pay_otherstotal; ?></th>
                                              <?php }if($dataval[0]['pay_cate_sa'] == 1){  ?>
                                    <th width='25%'><?php echo $pay_satotal;  ?></th>
                                     <?php }if($dataval[0]['pay_cate_madical'] == 1){  ?>
                                    <th width="10%"><?php echo $pay_madicaltotal  ?></th>

                                     <?php }if($dataval[0]['pay_cate_sp'] == 1){  ?>
                                     <th width='5%'><?php echo $pay_sptotal?></th>

                                           <?php }if($dataval[0]['pay_cate_ca'] == 1){  ?>
                                    <th width='25%'><?php echo $pay_catotal?></th>
                                                                             <?php }if($dataval[0]['pay_cate_hra'] == 1){  ?>
                                    <th width='25%'><?php echo $totalpay_hratotal?></th>
                                  
                                    <?php } ?>
                            <th width='25%'><?php echo $pay_total_sumtotal; ?></th>
                             <?php if($dataval[0]['pay_cate_gpf'] == 1){  ?>
                                    <th width='25%'><?php echo  $pay_gpftotal ?></th>
                                    <?php }if($dataval[0]['pay_cate_gpf_adv'] == 1){  ?>
                                   <th width="15%"><?php echo  $pay_gpf_advtotal ?> </th>
                                   <?php }if($dataval[0]['pay_cate_dpf'] == 1){  ?>
                                    <th width='5%'><?php echo    $pay_dpftotal ?></th>

                                     <?php }if($dataval[0]['pay_cate_dpf_adv'] == 1){  ?>
                                    <th width='25%'><?php echo   $pay_dpf_advtotal  ?></th>
                                   <?php }if($dataval[0]['pay_cate_defined_contribution'] == 1){  ?>
                                    <th width='25%'><?php echo $pay_defined_contributiontotal ?></th>
                                     <?php }if($dataval[0]['pay_cate_gias'] == 1){  ?>
                                    <th width="10%"><?php echo   $pay_giastotal ?></th>
                                  
                                        <?php }if($dataval[0]['pay_cate_house_loan'] == 1){  ?>
                            <th width='25%'><?php echo $pay_house_loantotal ?></th>

                            <?php }if($dataval[0]['pay_cate_car_loan'] == 1){  ?>


                                    <th width='25%'><?php echo $pay_car_loantotal ?></th>

                                        <?php }if($dataval[0]['pay_cate_house_rent'] == 1){  ?>
                                <th width='25%'><?php echo $pay_house_renttotal ?></th>

                          
                                
                                     <?php }if($dataval[0]['pay_cate_fuel_charge'] == 1){  ?>

                                   <th width="15%"><?php echo  $pay_fuel_chargetotal ?></th>

                                      <?php }if($dataval[0]['pay_cate_garain_adv'] == 1){  ?>
                                
                                     <th width='25%'><?php echo $pay_grain_advtotal ?></th>
                                      <?php }if($dataval[0]['pay_cate_festival_adv'] == 1){  ?>

                            <th width='25%'><?php echo  $pay_festival_advtotal ?></th>


                                      <?php }if($dataval[0]['pay_cate_professional_tax'] == 1){  ?>

                                    <th width='5%'><?php echo $pay_professional_taxtotal ?></th>

                                      <?php }if($dataval[0]['pay_cate_income_tax'] == 1){  ?>

                                <th width="10%"><?php echo  $pay_income_taxtotal ?></th>

                            
                                  <?php }if($dataval[0]['pay_cate_other_adv'] == 1){  ?>

                                    <th width='25%'><?php echo
									$pay_other_advtotal ?></th>

                                    <?php } ?>
                                   <th width="15%"><?php echo $pay_total_cuttotal ?></th>
                                   <th width="15%"><?php echo $pay_totaltotal  ?></th>
                              <th width="15%"></th>
                                </tr></tfoot>
...
no_updated=$("#no_updated"+id).val();
      ...
      $.post("<?php echo base_url();?>payroll/edit_slary_empbck",{
        'pay_month':$pay_month,
        'pay_id':$pay_id,
...
Darate =$("#darate"+id).val();
  $pay_basic =$("#pay_basic"+id).val();
	 $pay_da =$("#pay_da"+id).val();
    $pay_grp =$("#pay_grp"+id).val();
var npay =  +$pay_basic + +$pay_grp ;
varnd = (npay * Darate)/100;
 $pay_da =$("#pay_da"+id).val(varnd);
} 
