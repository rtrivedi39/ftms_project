                    ...
                    <div class="box-body">
                        ...
                        <table  class="table table-bordered table-striped display dataTable no-footer ">
                            ...
                            <?php  $i = 1;
                  			...
                  			<tr>
								<td width='5%'><?php  if($salary->pbill_type == 0){ echo "वेतन"; }else { echo !empty($salary->pbill_type)?get_bill_num_array($salary->pbill_type):'' ; } ?></td>
                                ...
                                <td width="15%"><?php if(isset($salary->pbill_computer_date) && $salary->pbill_computer_date!='0000-00-00' && $salary->pbill_computer_date!='1970-01-01') { echo date('d-m-Y',strtotime(@$salary->pbill_computer_date)); }?></td>
   								<td width="15%"><?php echo @$salary->pbill_office_no?></td>
      							<td width="15%"><?php echo @$salary->pbill_vocher_no?></td>
                				<td width="15%"><?php  if(isset($salary->pbill_vocher_date) && $salary->pbill_vocher_date!='0000-00-00' && $salary->pbill_vocher_date!='1970-01-01') { echo  date('d-m-Y',strtotime(@$salary->pbill_vocher_date )) ; } ?></td> 
