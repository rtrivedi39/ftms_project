...
<thead>   <tr>
                    <th width='15%'> </th>
                          ...
                          <th width='25%'><?php echo  "स्वीकृत अग्रिम/ब्याज सहित कुल कटोत्री की जाने वाली राशि"; ?></th>
                              <th width='25%'><?php echo  "क़िस्त नंबर"; ?></th>
                       
                          <th width='25%'><?php echo  "गृह निर्माण अग्रिम"; ?></th>
                                    
                                 <th width='25%'><?php echo  "इस माह तक अग्रिम एवं ब्याज सहित कुल कटोत्री की राशि"; ?></th>
                                ...
                                <td ><?php echo $k;?></td>
                                 ...
                                 <td ><?php echo get_employee_gender(emp_nmae($pay->pay_emp_unique_id)[0]->emp_id) ." ". emp_nmae($pay->pay_emp_unique_id)[0]->emp_full_name_hi . "(".  get_employee_designation_id(emp_nmae($pay->pay_emp_unique_id)[0]->emp_id).")"; ?></td>
                                    ...
                                    <td width='25%'> <?php echo $dd; ?></td>    
                                     ...
                                     <td width='25%'> <?php echo  $dd * @getinstlment($pay->pay_emp_unique_id,$pay->pay_month,$pay->pay_year,3)[0]->emi_no_installment; ?></td>    
             </tr>
