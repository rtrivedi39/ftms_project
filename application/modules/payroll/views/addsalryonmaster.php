...
<div class="col-lg-12 "> 
  ...
  <div class="form-group">
                <label for="file_type"><?php echo " कर्मचारी के बाद कर्मचारी की स्थिति को जोड़ने ";?></label> <span class="text-danger">*</span></label>
                 <div id="loadname">
...
}function showcurrentda()
{
	...
	$.get("<?php echo base_url();?>payroll/cate_emp_list/"+cateid,function(q){
		$("#loadname").html(q);
