...
class Home extends MX_Controller {
    ...
    public function index() {
        if ($this->session->userdata('is_logged_in')) {
            ...
            $data['notice'] = $this->admin_notice->fetchnoticebyid(null, 1);
                    ...
                    if ($user_data[0]->emp_is_retired) {
                       ...
                       $data = array(
                        ...
                        if ($user_data[0]->role_id == 1) {
                            ...
                            } else if(in_array($user_data[0]->role_id,array(28,29,30,34,35,36,40,42,43,44))){
                                  redirect('http://10.115.254.213/lms/dashboard');
                            }  else {
                                redirect('dashboard');                                ;
                            }                            
                        }
