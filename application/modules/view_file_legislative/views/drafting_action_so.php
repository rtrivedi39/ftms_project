                        ...
                        <form role="form" method="post" action="<?php echo base_url()?>view_file/Dealing_file/Sent_to_DA">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInputFile">फाईल को टीप दें </label>
                                    <textarea class="form-control"  name="file_remark" placeholder="Fill Remark Here"></textarea>
                                    <?php echo form_error('file_remark');?>
                                </div>
                                    <div class="form-group">
                                    <label for="exampleInputFile">संबंधित सहायको के नाम<span class="text-danger">*</span></label>
                                    <select class="form-control" name="Da_name" id="da_name" >
                                        <option value="">Select</option>
                                        <?php foreach($dealing_name as $daname) { ?>
                                            <?php if($daname['emp_id']!=emp_session_id()){ ?>
