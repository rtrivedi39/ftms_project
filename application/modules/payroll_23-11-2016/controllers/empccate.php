...
<table id="" class="table table-bordered table-striped dataTable " cellspacing="0" width="100%">
                            ...
                            <th width='25%'><?php  echo $this->lang->line('basic_pay');  ?></th>
                              ...
                              <?php }if($dataval[0]['pay_cate_special'] == 1){  ?>
                                   ...
                                   <?php }if($dataval[0]['pay_cate_other_add'] == 1){  ?>
                                    ...
                                    <th width='25%'><?php echo $this->lang->line('pay_hra');?></th>
...
{    background-color: #000000;color: #fff;
                                    ...
                                    <th width='25%'><?php $firstdigit= substr($pay->emp_unique_id, 0, 1); if($firstdigit == 5 ){$a = 0; }else{$a = "";}echo $a.$pay->emp_unique_id;  ?></th>
                            ...
                            <th width='25%'> 
                              <?php }else{?> 
                                 <th width='25%' style="background-color:red;color: #000;">
                              <?php } ?>
                                  ...
                                  <div class="username<?php echo $pay->pay_id; ?>" id="pay_special"> 
                                   ...
                                   <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
                                    <input type="numbar" id="pay_define<?php echo $pay->pay_id; ?>" value="<?php echo $pay->pay_defined_contribution;  ?>" name="pay_define"  >
                                        ...
                                        <?php }if($dataval[0]['pay_cate_house_loan'] == 1){  ?>
                                           <?php 
                                        $col = paydiff($pay->emp_unique_id,"pay_house_loan")[0]->pay_house_loan;
