    ...
    <div class="row">
     ...
     <div class="form-group">
                <label for="file_type"><?php echo $this->lang->line("basic_pay");?></label> <span class="text-danger">*</span></label>
				  ...
				  <input name="uid" id="uid" type="hidden" value="<?php echo $this->uri->segment(4);?>" />
...
<?php if($dataval[0]['pay_cate_da'] == 1){?>
         <div class="form-group">
               ...
               <input name="pay_da" type="number"   class="form-control"  id="pay_da" onfocus="totalvalue()" value="0" placeholder="<?php echo $this->lang->line('pay_da'); ?>">
  ...
  <?php }else{?>
    ...
    <?php }else{?>
		                  <input type="hidden" name="pay_sp" onfocus="totalvalue()"  id="pay_sp" placeholder="<?php echo $this->lang->line('pay_other_adv'); ?>"  value="0" class="form-control">
		...
		<?php } ?><?php if($dataval[0]['pay_cate_other_add'] == 1){?>
			<div class="form-group">
		      ...
		      <?php }else{?>
		                  <input type="hidden" name="pay_others" onfocus="totalvalue()"  id="pay_others" placeholder="<?php echo $this->lang->line('pay_other_adv'); ?>"  value="0" class="form-control">
    ...
    <?php if($dataval[0]['pay_cate_gpf'] == 1){?>
     <div class="form-group">
                ...
                <input type="number" onfocus="totalvalue()"   name="pay_gpf" id="pay_gpf" placeholder="<?php echo $this->lang->line('pay_gpf'); ?>"  value="0" class="form-control">
              
          </div>
           <?php }else{?>
		                  <input type="hidden" name="pay_gpf" onfocus="totalvalue()"  id="pay_gpf" placeholder=""  value="0" class="form-control">
     ...
     <div class="form-group">
                ...
                <input type="number" name="pay_dpf" id="pay_dpf" onfocus="totalvalue()"  placeholder="<?php echo $this->lang->line('pay_dpf'); ?>"  value="0" class="form-control">
              
          </div>
            
         <?php }else{?>
		                  <input type="hidden" name="pay_dpf" onfocus="totalvalue()"  id="pay_dpf" placeholder=""  value="0" class="form-control">
		...
		<?php } ?><?php if($dataval[0]['pay_cate_defined_contribution'] == 1){?>
         ...
         <div class="form-group">
                <label for="file_type"><?php echo $this->lang->line("pay_define");?></label> <span class="text-danger">*</span></label>
                       ...
                       <input type="number" name="pay_define" onfocus="totalvalue()"  id="pay_define" placeholder="<?php echo $this->lang->line('pay_define'); ?>"  value="0" class="form-control">
          </div>
       <?php }else{?>
		                  <input type="hidden" name="pay_define" onfocus="totalvalue()"  id="pay_define" placeholder=""  value="0" class="form-control">
 ...
 <?php }else{?>
		                  <input type="hidden" name="pay_gias" onfocus="totalvalue()"  id="pay_gias" placeholder=""  value="0" class="form-control">
	 ...
	 <?php }else{?>
		                  <input type="hidden" name="pay_house_rent" onfocus="totalvalue()"  id="pay_house_rent" placeholder=""  value="0" class="form-control">
		...
		<?php } ?>    <?php if($dataval[0]['pay_cate_fuel_charge'] == 1){?>
			...
			<?php }else{?>
		                  <input type="hidden" name="pay_fule_charge" onfocus="totalvalue()"  id="pay_fule_charge" placeholder=""  value="0" class="form-control">
		...
		<?php } ?>
			...
			<div class="form-group">
               ...
               <input type="number" name="pay_professional_tax" id="pay_professional_tax" placeholder="<?php echo $this->lang->line('pay_professional_tax'); ?>"  value="0" class="form-control">
				...
				<?php }else{?>
		                  <input type="hidden" name="pay_fuel_charge" onfocus="totalvalue()"  id="pay_fuel_charge" placeholder=""  value="0" class="form-control">
     ...
     <?php if($dataval[0]['pay_cate_income_tax'] == 1){?>
            ...
            <div class="form-group">
                <label for="file_type"><?php echo $this->lang->line("pay_income_tax");?></label> <span class="text-danger">*</span></label>
                  ...
                  <input type="number" name="pay_income_tax" id="pay_income_tax" onfocus="totalvalue()"  placeholder="<?php echo $this->lang->line('pay_income_tax'); ?>"  value="0" class="form-control">
            </div>
			    <?php }else{?>
		                  <input type="hidden" name="pay_income_tax" onfocus="totalvalue()"  id="pay_income_tax" placeholder="<?php echo $this->lang->line('pay_other_adv'); ?>"  value="0" class="form-control">
		...
		<?php } ?><?php if($dataval[0]['pay_cate_other_adv'] == 1){?>
            ...
            <div class="form-group">
                <label for="file_type"><?php echo $this->lang->line("pay_other_adv");?></label> <span class="text-danger">*</span></label>
                  ...
                  <input type="number" name="pay_other_adv" onfocus="totalvalue()"  id="pay_other_adv" placeholder="<?php echo $this->lang->line('pay_other_adv'); ?>"  value="0" class="form-control">
            </div>
        <?php }else{?>
		                  <input type="hidden" name="pay_other_adv" onfocus="totalvalue()"  id="pay_other_adv" placeholder=""  value="0" class="form-control">
		...
		<?php } ?>
	            <div class="form-group">
	                <label for="file_type"><?php echo $this->lang->line("pay_total_cut");?></label> <span class="text-danger">*</span></label>
	                  ...
	                  <input type="number" name="pay_total_cut" onfocus="showtotal_DIII()" id="pay_total_cut" placeholder=""  value="0" class="form-control">
	            </div>
        <div class="form-group ">
	                <label for="file_type">कुल </label> <span class="text-danger">*</span></label>
	               
	                  <input type="number" name="pay_total" onfocus="totalvalue()" id="pay_total" placeholder=""  value="0" class="form-control">
          </div>
     </div>
		<div class="col-lg-12">
