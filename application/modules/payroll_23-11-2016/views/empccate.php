...
<tr style="text-align:center">
      ...
      <h2>विषय: माह <?php echo $this->uri->segment("4");?> 2016 का न्यायिक सेवा  
        ...
        <?php if(count($pay_bill)== 0){echo "---";}
          ...
          <?php if(count($pay_bill)== 0){ 
            echo "---";
          }else{ echo date("d-m-Y",strtotime(@$pay_bill[0]->pbill_computer_date	));
  ...
  <tr style="text-align:center">
    <td colspan="32"><h2>विषय: माह <?php echo $this->uri->segment("4");?>
     2016 का चतुर्थ श्रेणी  शासकीय सेवकों  का वेतन विवरण पत्रक
       कम्प्यूटर देयक क्रमांक   <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_computer_no; }?>   
            दिनांक   <?php echo date("d-m-Y",strtotime(@$pay_bill[0]->pbill_computer_date	)); ?>  ऑफिस देयक क्रमांक  <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_office_no; }?>     दिनांक  <?php if(count($pay_bill)== 0){ 
            echo "---";
          }else{ echo date("d-m-Y",strtotime(@$pay_bill[0]->pbill_computer_date ));
        } ?></h2></td>
  ...
  <tr style="text-align:center">
    <td colspan="32"><h2>विषय: माह <?php echo $this->uri->segment("4");?> 
      2016 का परिभाषित अशंदान  शासकीय सेवकों का वेतन विवरण पत्रक  कम्प्यूटर देयक क्रमांक
         <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_computer_no; }?>        दिनांक  
        <?php if(count($pay_bill)== 0){ 
            echo "---";
...
द्वितीय एवं तृतीय  श्रेणी  शासकीय सेवकों का वेतन विवरण पत्रक  कम्प्यूटर देयक क्रमांक   <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_computer_no; }?>        दिनांक  <?php if(count($pay_bill)== 0){echo "---";}else{ echo date("d-m-Y",strtotime($pay_bill[0]->pbill_computer_date	));  } ?>  ऑफिस देयक क्रमांक  <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_office_no; }?>     दिनांक  <?php if(count($pay_bill)== 0){ 
            echo "---";
          }else{ echo date("d-m-Y",strtotime(@$pay_bill[0]->pbill_computer_date	));
        } ?></h2></td>
...
द्वितीय एवं तृतीय  श्रेणी  शासकीय सेवकों का वेतन विवरण पत्रक  कम्प्यूटर देयक क्रमांक   <?php if(count($pay_bill)== 0){echo "---";}
  ...
  <tr style="text-align:center">
    <td colspan="32"><h2>विषय: माह <?php echo $this->uri->segment("4");?> 2016 का प्रथम ,   
द्वितीय एवं तृतीय   श्रेणी  शासकीय सेवकों का वेतन विवरण पत्रक  कम्प्यूटर देयक क्रमांक   <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_computer_no; }?>        दिनांक  <?php if(count($pay_bill)== 0){echo "---";}else{ echo date("d-m-Y",strtotime($pay_bill[0]->pbill_computer_date	));  } ?> ऑफिसदेयक क्रमांक  <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_office_no; }?>     दिनांक  <?php if(count($pay_bill)== 0){ 
            echo "---";
          }else{ echo date("d-m-Y",strtotime(@$pay_bill[0]->pbill_computer_date	));
        } ?></h2></td>
   ...
   <?php }elseif($emp_id == 14){ ?>


  <tr style="text-align:center">
    <td colspan="32"><h2>विभाग के आदेश क्रमाक 8708/21-अ (स्था0) भोपाल दिनांक 07-12-2015 द्वारा श्री मंयक श्रोती, विधिक सहायक का निलंबन  जीवन निर्वाह भत्ता,<?php echo $this->uri->segment("4");?>, 2016 कम्प्यूटर देयक क्रमाक    <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_computer_no; }?>    दिनांक <?php if(count($pay_bill)== 0){echo "---";}else{ echo date("d-m-Y",strtotime($pay_bill[0]->pbill_computer_date  ));  } ?>आफिस देयक क्रमाक   <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_office_no; }?>     दिनांक  <?php if(count($pay_bill)== 0){ 
            echo "---";
          }else{ echo date("d-m-Y",strtotime(@$pay_bill[0]->pbill_computer_date ));
        } ?></h2></td>
...
<?php }elseif($emp_id == 7 ){ ?>
  ...
  <tr style="text-align:center">
    <td colspan="32"><h2>विषय: 29-2014 न्याय  प्रशासन 3428 चतुर्थ श्रेणी  शासकीय सेवकों का का माह <?php echo $this->uri->segment("4");?> 2016 वेतन विवरण पत्रक  कम्प्यूटर देयक क्रमांक   <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_computer_no; }?>        दिनांक  <?php if(count($pay_bill)== 0){echo "---";}else{ echo date("d-m-Y",strtotime($pay_bill[0]->pbill_computer_date	));  } ?> ऑफिस देयक क्रमांक  <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_office_no; }?>     दिनांक  <?php if(count($pay_bill)== 0){ 
            echo "---";
          }else{ echo date("d-m-Y",strtotime(@$pay_bill[0]->pbill_computer_date	));
...
<?php }elseif($emp_id == 5 ){ ?>
  ...
  <tr style="text-align:center">
    <td colspan="32"><h2>विषय: माह <?php echo $this->uri->segment("4");?> 2016 का  परिभाषहित अशंदान  कर्मचारियों का वेतन विवरण पत्रक  कम्प्यूटर देयक क्रमांक   <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_computer_no." "; ?>   दिनांक   <?php echo date("d-m-Y",strtotime(@$pay_bill[0]->pbill_computer_date	)); } ?>  ऑफिस देयक क्रमांक  <?php if(count($pay_bill)== 0){echo "---";}
        else{echo @$pay_bill[0]->pbill_office_no; }?>     दिनांक  <?php if(count($pay_bill)== 0){ 
            echo "---";
          }else{ echo date("d-m-Y",strtotime(@$pay_bill[0]->pbill_computer_date	));
        } ?></h2></td>
...
<thead style="background:white" >
 ...
 <?php }if($dataval[0]['pay_cate_garain_adv'] == 1){  ?>
	 ...
	 <tbody>     
								 ...
								 $pdiff=paydiff($pay->emp_unique_id,$pay->pay_month,$pay->pay_year);
								
									$gender =  $pay->emp_detail_gender;
									$martial =  $pay->emp_detail_martial_status;
		...
		tr.printdrak{
		  background-color:#FF9800 !important;
                  ...
                  color: #000 !important; " class="printdrak">
                                    ...
                                    <th ><?php echo $pay->trunique; ?></th>
                                    <th ><?php echo $ms." ".$pay->emp_full_name_hi." <br/>  (". $pay->emprole_name_hi.")"; ?></th>
                                  <!--   <th ><?php echo date("M",strtotime($pay->pay_month)); ?></th>-->
                                        <?php if($dataval[0]['pay_cate_basic'] == 1){ 
                                          
                                         ?>
                                        <?php 
                                        $col = @$pdiff[0]->pay_basic;
...
print-color-adjust: exact;
                              ...
                              <?php } ?> 
                                    ...
                                    <?php } ?>     <?php 
                                        $col =  @$pdiff[0]->pay_total_sum;                    
                                         if ( $col ==  $pay->pay_total_sum) { ?>
                                       
                           <th style="padding:0;<?php echo $col;?>"> 
                              <?php }else{?> 
                                 <th  class="changehead">
                                  <style type="text/css">
                              ...
                              <?php } ?> 
                                   ...
                                   <div class="username1<?php echo $pay->pay_id; ?>" style="display:none" >
                                    <input type="numbar" id="pay_dpf_adv<?php echo $pay->pay_id; ?>" value="<?php echo $pay->pay_dpf_adv;  ?>"  name="pay_dpf_adv" >
									   ...
									   <?php }if($dataval[0]['pay_cate_defined_contribution'] == 1){  ?>
                                                 <?php 
                                        $col = @$pdiff[0]->pay_defined_contribution;
                              ...
                              <?php echo $pay->pay_festival_adv; ?>
                                    ...
                                    <input type="numbar" id="pay_festival_adv<?php echo $pay->pay_id; ?>" value="<?php echo $pay->pay_festival_adv;  ?>"  name="pay_festival_adv" >
                                      ...
                                      <?php }if($dataval[0]['pay_cate_professional_tax'] == 1){  ?>
                                                 ...
                                                 <?php 
                                        $col =@$pdiff[0]->pay_professional_tax;
