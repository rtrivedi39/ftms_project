...
<th width='15%'><?php echo  "शेष"; ?></th>
  ...
  </thead>                  <?php  $k =0;$dd =""; $tt = 0;foreach ($pay_salary as $key => $pay) { 
                                       ...
                                       elseif($dd_key == "pay_gias"){$dd =$pay->pay_gias ;}
                                         elseif($dd_key == "pay_defined_contribution"){$dd =$pay->pay_defined_contribution; }
                                          ...
                                          elseif($dd_key == "pay_professional_tax"){$dd =$pay->pay_professional_tax; }
                                                  ...
                                                  elseif($dd_key == "pay_other_adv"){$dd =$pay->pay_other_adv; }
                                                          if($dd != 0){ $k++;                 ?> 
 ...
 <th width="10%"></th>     <th width='25%'><?php echo  sumcolumn($dd_key ,$this->uri->segment("4"),$this->uri->segment("5"))['val']; ?></th>
                                  <th width="10%"></th>
                                    <th width="10%"></th> 
                                     <th width="10%"></th>
                               <th width="10%"></th>
