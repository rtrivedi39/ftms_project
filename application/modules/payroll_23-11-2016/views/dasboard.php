...
<section class="content">
    ...
    <div class="row">
     ...
     ?>
               ...
               <div class="col-xs-2">
    <a  id="<?php echo $sal_Cate->pay_cate_id; ?>" href="<?php echo base_url(); ?>payroll/empcate/<?php echo $sal_Cate->pay_cate_id; ?>/<?php  echo  $currentmonth ?>"  class="btn btn-block btn-info" ><?php echo $sal_Cate->pay_cate_name; ?></a><br/>
    </div>
    <?php }?>
            </div><!-- /.box --></div>
        </div>
