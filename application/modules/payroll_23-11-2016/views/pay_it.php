...
<thead>   <tr>
                    <th width='15%'> </th>
                                ...
                                <td ><?php echo "पेन नंबर"; ?></td>
                                  <td ><?php echo "सकल राशी"?></td>
                                  <?php } ?>
                          <th width='25%'><?php echo  $this->lang->line($dd_key )." कटोती राशी "; ?></th>
                          ...
                          <tr id="<?php echo $pay->pay_id; ?>">
                                 ...
                                 <td ><?php echo get_employee_gender(emp_nmae($pay->pay_emp_unique_id)[0]->emp_id) ." ". emp_nmae($pay->pay_emp_unique_id)[0]->emp_full_name_hi. "(".  get_employee_designation_id(emp_nmae($pay->pay_emp_unique_id)[0]->emp_id).")"; ?></td>
                                  ...
                                  <td ><?php $pen= getemppenno($pay->pay_emp_unique_id);echo $pen['emp_pen_no'] ?></td>
                                  <td ><?php echo $pay->pay_total_sum?></td>
      ...
      <tr style="background-color: #8BC34A; font-size: 16px;font-weight: bold;    color: #000;">
                                    ...
                                    <th width="10%"></th> 
                                     ...
                                     <th width="10%">Total </th>
                                      <th width="10%"></th>
                                           <th width='25%'><?php echo  sumcolumn('pay_total_sum' ,$this->uri->segment("4"),$this->uri->segment("5"))['val']; ?></th>
...
<tr>
                                    ...
                                    <th colspan="19"align="center"> <center><h2><?php 
$number = sumcolumn($dd_key ,$this->uri->segment("4"),$this->uri->segment("5"))['val'];
   $no = round($number);
