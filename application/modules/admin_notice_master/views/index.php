                    ...
                    <?php if(count(@$get_notice)>0) {?>
                      <?php $i=1; foreach (@$get_notice as $key => $notice) { ?>
                        <tr>
                          ...
                          <td><?php echo $notice['notice_title'] ."/".$notice['section_name_en'];?>
							    <?php if(isset($notice['notice_attachment'])){ ?>
                                    <div class="form-group">
                                        <a href="<?php echo base_url(); ?>uploads/notice/<?php echo $notice['notice_attachment'] ?>" target="_blank">Attectment</a>
                                    </div>
                                <?php } ?>
						 </td>
                          ...
                          <td>
                              <div class="btn-group">
                                ...
                                <?php if($this->session->userdata('emp_id') == 1){?>
