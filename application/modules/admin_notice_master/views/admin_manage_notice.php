                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="notice_status" id="notice_status">
                                        ...
                                        <?php } ?>
                                        <option value="1" <?php if($notice1_detail['notice_is_active'] == 1) echo 'selected'; ?>>Active</option>
                                        <option value="0" <?php if($notice1_detail['notice_is_active'] == 0) echo 'selected'; ?>>In Active</option>
                                    </select>
                                </div>
                         </div><!-- /.box-body -->
