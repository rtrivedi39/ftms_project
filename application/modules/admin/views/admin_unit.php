<!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url().'dashboard'?>"><i class="fa fa-dashboard"></i><?php echo $this->lang->line('unit_dashboard'); ?></a></li>
                    ...
                    <tbody>
                      <?php $i=1; foreach ($get_unit as $key => $unit) { ?>
                        <tr>
                          ...
                          <td>
                              <div class="btn-group">
                                 <a href="<?php echo base_url('admin');?>/manage_unit/<?php echo $unit['unit_id'];?>" class="btn  btn-twitter"><?php echo $this->lang->line('unit_action_button'); ?></a>
