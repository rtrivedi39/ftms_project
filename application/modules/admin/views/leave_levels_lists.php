                  ...
                  <table id="leave_employee" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th><?php echo $this->lang->line('employee_post') ?></th>
                    ...
                    <tbody>
                      ...
                      if($leave_level_lists != ''){
                        ...
                        <tr>
                            <td><?php echo $i;?></td>
                            <td><?php echo getemployeeName($row->emp_id);?></td>
                            <td><?php echo get_employee_role($row->emp_id, true);?></td>
                            <td><?php echo getemployeeName($row->forwarder_id);?>/<?php echo get_employee_role($row->forwarder_id, true);?></td>
                            <td><?php echo getemployeeName($row->recommender_id);?>/<?php echo get_employee_role($row->recommender_id, true);?></td>
                            <td><?php echo getemployeeName($row->approver_id);?>/<?php echo get_employee_role($row->approver_id, true);?></td>
                            <td>
                              <div class="btn-group">
                                <a href="<?php echo base_url('admin');?>/delete_level_lists/<?php echo $row->hirarchi_id;?>"  class="btn  btn-danger"  onclick="return confirm('Are you sure?');"><?php echo $this->lang->line('delete') ?></a>
