                  ...
                  <table id="leave_employee" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th><?php echo $this->lang->line('district_pincode_label') ?></th>
                    ...
                    <tbody>
                      <?php $i=1; foreach ($get_district as $key => $district) { ?>
                        <tr>
                          ...
                          <td><?php echo @$district['pincode'];?></td>
                          ...
                          <td>
                              <div class="btn-group">
								...
								<a href="<?php echo base_url(); ?>admin/tahsil/index/<?php echo $district['district_id'];?>" class="btn  btn-twitter"><?php echo $this->lang->line('tahsil_add_label') ?></a>		
								<a href="<?php echo base_url(); ?>admin/taluka/index/<?php echo $district['district_id'];?>" class="btn  btn-twitter"><?php echo $this->lang->line('taluka_add_label') ?></a>		
