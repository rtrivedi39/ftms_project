                ...
                <form role="form" method="post" action="<?php echo site_url(); ?>admin/admin_department/addUpdatedepartment<?php if(isset($dpid)){ echo '/'.$dpid;} ?>">
                    <div class="box-body">
                         <div class="tree well">
                            <ul>
                                <li>
                                    <span class="bg-success"><i class="icon-folder-open" ></i> <?php /*echo getemployeeRole(3);*/ echo getemployeeName('264', true, $isgender = true); ?>/ <?php  echo getemployeeRole(3); ?></span> 
                                <?php if(!empty($this->depart_struct->get_departmental_structure(264))){
                                    echo " <ul>";
                                    foreach($this->depart_struct->get_departmental_structure(264) as $row){ ?>
                                        <li>
                ...
                <div class="box-header">
                 ...
                 <!-- form start -->
                    <div class="box-body">
                        ...
                        <div class="bg-default">9. अन्य</div><br/>
                    </div>
              </div>
            </div>
          </div><!-- /.row -->
