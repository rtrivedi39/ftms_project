                  ...
                  <table id="leave_employee" class="table table-bordered table-striped">
                    <thead>
                      <tr>
						...
						<th><?php echo $this->lang->line('officer_name') ?></th>
						<th><?php echo $this->lang->line('officer_number') ?></th>
						<th><?php echo $this->lang->line('officer_email') ?></th>						
                    ...
                    <tbody>
                      <?php $i=1; foreach ($get_department as $key => $department) { ?>
                        <tr>
                          ...
                          <td><?php echo $department['department_default_no'];?></td>
						   <td><?php echo $department['dept_officer_nm'];?></td>
						   <td><?php echo $department['dept_officer_number'];?></td>
						   <td><?php echo $department['dept_officer_email'];?></td>
                          <td>
                              <div class="btn-group">
