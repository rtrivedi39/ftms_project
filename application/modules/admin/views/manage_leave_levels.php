            ...
            <div class="col-xs-6">
              ...
              <div class="box box-primary">
                <div class="box-header">
                 ...
                 ?>
                <form role="form" method="post" action="<?php echo site_url(); ?>admin/leave_levels/add_update_leave_levels">
                        ...
                        <div class="form-group">
                            ...
                            <select name="emp_id" class="form-control">
                                ...
                                foreach($this->leave_levels_model->get_all_employee($all) as $row) { ?>
                                    <option value="<?php echo $row->emp_id; ?>"  <?php echo (isset($edit_emp_id) && $edit_emp_id == $row->emp_id) ? 'Selected' : '' ;?>><?php echo $row->emp_full_name; ?>/<?php echo getemployeeRole($row->role_id); ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="forwarder_id" class="form-control">
                                ...
                                <?php foreach($this->leave_levels_model->get_forwarder() as $row) { ?>
                                    <option value="<?php echo $row->emp_id; ?>"  <?php echo (isset($forwoder_id) && $forwoder_id == $row->emp_id) ? 'Selected' : '' ;?>><?php echo $row->emp_full_name; ?>/<?php echo getemployeeRole($row->role_id); ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="recommender_id" class="form-control">
                                ...
                                <?php foreach($this->leave_levels_model->get_recommender() as $row) { ?>
                                    <option value="<?php echo $row->emp_id; ?>" <?php echo (isset($recommender_id) && $recommender_id == $row->emp_id) ? 'Selected' : '' ;?>><?php echo $row->emp_full_name; ?>/<?php echo getemployeeRole($row->role_id); ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="approver_id" class="form-control">
                                ...
                                <?php foreach($this->leave_levels_model->get_approver() as $row) { ?>
                                    <option value="<?php echo $row->emp_id; ?>"  <?php echo (isset($approver_id) && $approver_id == $row->emp_id) ? 'Selected' : '' ;?>><?php echo $row->emp_full_name; ?>/<?php echo getemployeeRole($row->role_id); ?></option>
                                <?php } ?>
                            </select>
