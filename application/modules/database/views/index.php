              ...
              <div class="box">
                 ...
                 <h3 class="box-title no-print"><?php echo $title_tab;?></h3>
					...
					<?php if($adv_type == 2){
						...
						<a  href="<?php echo base_url();?>advocate/list/<?php echo $adv_type; ?>/rdo" <?php if(!empty($search_type) && $search_type == 'rdo') { echo 'disabled'; }?>  class="btn b btn-sm btn-info">
							<?php echo $advocate_type_name; ?> जिनका नवीनीकरण ख़त्म हो गया है 
						</a>
				...
				<!-- /.box-header -->
                   <div class="clearfix"></div>
					<br>
                    <div style="width:650px;" class="pull-right filter_state no-print">
					...
					<div id="taluka_div" class="col-md-3">
					<span></span>
					<span></span>
					<span></span>
                    </div>  
                  ...
                  <table id="leave_employee" class="table table-bordered table-striped">
                    <thead>
                      <tr>			
						 ...
						 <th>परिवीक्षा काल </th>
						 <?php if(!in_array($userrole,$upper_officer)){ ?><th class="no-print">Actions</th><?php } ?>
							
						 <th width="20%" class="no-print" >पैनल की स्थिति</th>
						 ...
						 <tr style="background:<?php echo @$color; ?>">
							...
							<td><?php
								...
								if($users['scm_name_hi']!=''){ 
									?>
								<a style="curser:pointer;"  onclick="#"  >
							...
							<?php if($adv_type == 4){ ?>
								<td><?php if(!empty($users['first_appointment_date']) && $users['first_appointment_date']!='1970-01-01' && $users['first_appointment_date']!='0000-00-00' ){ echo date('d-m-Y',strtotime($users['posting_date']));}else{ echo 'N/A';}?></td>
							<?php } ?>
