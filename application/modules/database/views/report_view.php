...
<div id="advocates">
        <section class="content-header">
          <h1 class="adv_title">
            <?php// echo $title; ?>
			<?php echo $tit; ?>की जिलेवार स्वीकृत पद देखे
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active"><?php echo $tit; ?> की जिलेवार स्वीकृत पद देखे</li>
          </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="box-header">
					...
					<?php if($adv_type == 1){ ?>
						...
						<a  href="<?php echo base_url();?>advocate/list/<?php echo $adv_type; ?>/rdo" <?php if(!empty($search_type) && $search_type == 'rdo') { echo 'disabled'; }?>  class="btn b btn-sm btn-info">
							<?php echo $tit; ?> जिनका नवीनीकरण ख़त्म हो गया है 
						</a>
			 ...
			 <th>क्रमांक</th>
                    ...
                    <tbody>
					 ...
					 //pre($get_users);
                        ...
                        <tr>
						<td><?php echo $i ; ?> <br/> <?php echo 'ID-'.$users['advocate_posting_id'] ; ?></td>
							 <td>
							...
							<td>
								<?php   
									if(!empty($users['district_id'])  && !empty($users['tahsil_id'])){
										...
										if(empty($agpname)){
											$pst = ''	;	
											if($adv_type == '1'){ $pst = 'जी.पी. के' ; } if($adv_type == '2'){ $pst = 'ए.जी.पी. के' ; }
											//echo $adv_type;
									if($users['vacant_seats'] == 0){	
									...
									foreach($agpname as $ky=>$agp_gp_name_val){
										echo '<div class="col-md-6 pull-left">'.$agp_gp_name_val->scm_name_hi.'</div>';									
									?>
...
?>
							...
							<td class="no-print">
							<!--Delete-->								
						  		<button class="btn  btn btn-danger" onclick="return delte_post( '<?php echo $adv_type; ?>','<?php echo $users['advocate_posting_id'] ; ?>');"><?php echo 'नष्ठ करें' ?> </button>
