...
<div class="col-md-6">
    <div class="box box-primary">
        <div class="box-body">
            ...
            <div class="box box-solid collapsed-box"> <!--collapsed-box-->
                ...
                <div id="add_multi_subtype">
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            ...
                            <div id="scan_subfile_types_div0"><select class="form-control" name="scan_subfile_types[]" id="scan_subfile_types0" required>
                            </select>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var scan_file_perent = '<?php echo json_encode($scan_file_perent) ; ?>';
            ...
            $.ajax({
                ...
                success: function(data) {
                    var r_data = JSON.parse(data);
                        var otpt = '<select class="form-control" name="scan_subfile_types[]" id="scan_subfile_types'+sgtf+'" required>';
