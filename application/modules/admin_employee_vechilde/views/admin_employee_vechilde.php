                                   ...
                                   ?>dgdfg
                                    <select class="form-control" name="section_id" >
                                        <option value=""><?php echo $this->lang->line('heads_designation_select_label'); ?></option>
                                            <?php 
												$employee_list = get_all_employee_ddllist('emp_name' ,'');
												foreach ($employee_list as $empk => $emp_list) { ?>
                                               <?php if($heads_detail['section_id'] == $emp_section['section_id']){
												   ?>
												    <option value="<?php echo $emp_list['emp_id']; ?>" selected ><?php echo $emp_list['emp_full_name_hi']; ?> (<?php echo $emp_section['section_name_en']; ?>)  </option>
												   <?php
											   }else{?>
                                                        <option value="<?php echo $emp_list['emp_id']; ?>"  ><?php echo $emp_list['emp_full_name_hi']; ?> (<?php echo $emp_section['section_name_en']; ?>)  </option>
											 <?php } ?>
                                            <?php } ?>
                                    </select>
