...
class Admin_sections_master extends MX_Controller {
     function __construct() {
		...
		$this->load->language('admin_sections_master','hindi');
    ...
    {
        $data = array();
         $data['title'] = $this->lang->line('section_title');
    ...
    public function manage_section($id=null){
        ...
        $data['title_tab'] = $this->lang->line('all_section_label'); 
        if($id==null){
            $data['page_title'] = $this->lang->line('section_add_label');
            $data['is_page_edit']=1;

        }else{
            $data['page_title'] = $this->lang->line('section_edit_label');
            $data['is_page_edit']=0;
