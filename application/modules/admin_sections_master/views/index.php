                  ...
                  <table id="leave_employee" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th><?php echo $this->lang->line('section_action_label'); ?></th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php $i=1; foreach ($get_section as $key => $sections) { ?>
                        <tr>
                          ...
                          <td>
                              <div class="btn-group">
                                <a href="<?php echo base_url('admin');?>/edit_section/<?php echo $sections['section_id'];?>" class="btn  btn-twitter"><?php echo $this->lang->line('section_action_button'); ?></a>
