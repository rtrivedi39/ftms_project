    ...
    <div class="box box-primary">
        <div class="box-body">
		 <div class="form-group">
			...
			<!--Dropdown-->
            <div class="form-group" >
                <label for="file_type"><?php echo $this->lang->line('label_amount'); ?></label> <span class="text-danger">*</span></label>
                 <input type="text" name="bill_amount"  value="" placeholder="<?php echo $this->lang->line('employee_ac_no'); ?>" class="form-control">
