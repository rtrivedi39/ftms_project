...
<div class="col-md-6">
    <div class="box box-primary">
        <div class="box-body">
			...
			<div class="form-group">
                <label for="bill_cetegory"><?php echo $this->lang->line('label_bill_category'); ?></label> <span class="text-danger">*</span></label>
				<?php $billcategories = es_file_billcategory(); ?>
                 <select name="bill_category" id="bill_category" class="form-control">
					<option >बिल का श्रेणी</option>
					<?php if(isset($billcategories)){
						foreach($billcategories as $category_key=>$billcategory){?>
						<option value="<?php echo $category_key; ?>"><?php echo $billcategory ?></option>
						<?php
			...
			<div class="form-group" >
                <label for="bill_type"><?php echo $this->lang->line('label_bill_type'); ?></label> <span class="text-danger">*</span></label>
				<?php $billtypes = es_file_billtype(); ?>
                 <select name="bill_type" id="bill_type" class="form-control">
					<option >बिल का प्रकार</option>
					<?php if(isset($billtypes)){
						foreach($billtypes as $bill_key=>$bill){?>
						<option value="<?php echo $bill_key; ?>"><?php echo $bill ?></option>
						<?php
			...
			<div class="form-group" id="employee_list" style="display:none">
			...
			<div class="form-group"  >
                <label for="bill_amount"><?php echo $this->lang->line('label_amount') ?></label>
                <input type="text" name="bill_amount"  value="" placeholder="<?php echo $this->lang->line('label_amount'); ?>" class="form-control">
               
            </div>

            <div class="form-group">
                <label for="bill_no" ><?php echo $this->lang->line('label_bill_no') ; ?>
                </label></label>
                <input type="text" name="bill_no" id="bill_no"  value="<?php if ($this->input->post('bill_no')){ echo $this->input->post('bill_no');}  ?>" placeholder="<?php echo $this->lang->line('label_bill_no'); ?>" class="form-control date1">
                
            </div>
			
		<div class="form-group">
                <label for="discription"><?php echo $this->lang->line('label_file_discription'); ?></label> <span class="text-danger">*</span></label>
				<textarea name="file_discription" id="file_discription" class="form-control"></textarea>
