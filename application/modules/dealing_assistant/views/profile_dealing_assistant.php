                    ...
                    <div class="box box-primary" style="margin-top: 15px;">
                      ...
                      <div class="box-body">
                          ...
                          <div class="form-group">
                            ...
                            <?php 
                              $status='N/A';
                              if($assistant_details->emp_detail_martial_status=='2'){
                                $status='विवाहित (Married)';  
                              }if($assistant_details->emp_detail_martial_status=='1'){
                                $status='अविवाहित (Single)';  
                              }
                              echo (@$assistant_details->emp_detail_martial_status ? @$status:'');?>
                          ...
                          <div class="form-group">
                            <label for="exampleInputFile"><?php echo $this->lang->line('emp_state'); ?>:</label>
							               <?php if(isset($assistant_details->emp_detail_state)){ echo getState($assistant_details->emp_detail_state); } ?>
